...
async fn initialize_database(db: &Database) -> Result<(), Box<dyn std::error::Error>> {
    ...
    // 📅 SEED ACADEMIC YEAR - DISABLED (use: node seed.js instead)
